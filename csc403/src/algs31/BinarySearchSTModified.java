...
public class BinarySearchSTModified<K extends Comparable<? super K>, V> {
	private static final int INIT_CAPACITY = 2;
	private K[] keys;
	private V[] vals;
	private int N = 0;
	
	public static int comparecounts;

	// create an empty symbol table with default initial capacity
	public BinarySearchSTModified() { this(INIT_CAPACITY); }

	// create an empty symbol table with given initial capacity
	@SuppressWarnings("unchecked")
	public BinarySearchSTModified(int capacity) {
	...
	public int rank(K key) {
		...
		while (lo <= hi) {
			...
			//count compares
			count++;
			System.out.print("key: " + key.toString() + " compare to " + keys[m].toString() + ": " + count + "\n");
	...
	public static void main(String[] args) {
		...
		BinarySearchSTModified<String, Integer> st = new BinarySearchSTModified<>();
